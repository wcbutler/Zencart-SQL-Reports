...
CONCAT('https://tolivealie.com/store/index.php?main_page=product_info&cPath=3&products_id=', products.products_id) as link,
CONCAT('https://tolivealie.com/store/images/', products_image) as image_link,
